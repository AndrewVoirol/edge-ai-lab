...
/// Ships 8 default evaluation suites covering math, tool calling, reasoning, multimodal,
/// instruction following, Gemma 4 capabilities, code generation, and long context.
///
