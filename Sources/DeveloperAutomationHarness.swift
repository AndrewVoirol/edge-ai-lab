...
// The [AUTOMATION], [AUTOMATION_SUCCESS], [AUTOMATION_FAILURE], and
// [AUTOMATION_RESULTS_JSON] prefixed lines are protocol output consumed
// by automation scripts (run_matrix.py, ci_test_runner.sh). Do NOT
// replace these with os.Logger — they must go to stdout for parsing.
