...
struct ChatBubbleView: View {
    ...
    private var contentBubble: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            if message.role == .assistant && !message.content.isEmpty && !message.isStreaming {
                HStack {
                    ...
                    .accessibilityLabel("Fork experiment")
        ...
        .background(
            Group {
                ...
                case .toolResult:
                    if reduceTransparency {
                        Rectangle().fill(AppColors.toolCall.opacity(0.85))
                    } else {
    ...
    private func thinkingSection(_ thinking: String) -> some View {
        VStack(alignment: .leading, spacing: AppSpacing.xs) {
            ...
            .accessibilityLabel("Reasoning section, \(message.thinkingWordCount) words")
            .accessibilityHint("Double-tap to toggle thinking details")
            .accessibilityValue(showThinking ? "expanded" : "collapsed")
    ...
    private func toolCallChip(_ event: ToolCallEvent) -> some View {
        VStack(alignment: .leading, spacing: AppSpacing.xs) {
            ...
            .accessibilityLabel("Tool: \(event.toolName), \(event.succeeded ? "succeeded" : "failed")")
