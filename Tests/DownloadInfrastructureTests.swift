...
final class DownloadInfrastructureTests: XCTestCase {
    ...
    @MainActor
    func testStateTransition_Downloading_CancelToNotDownloaded() {
        let manager = ModelDownloadManager()
    ...
    @MainActor
    func testStateTransition_Queued_CancelToNotDownloaded() {
        let manager = ModelDownloadManager()
    ...
    @MainActor
    func testStateTransition_Failed_ToNotDownloaded_ViaCancel() {
        let manager = ModelDownloadManager()
    ...
    @MainActor
    func testCancelDownload_Filename_WhenDownloading_SetsNotDownloaded() {
        let manager = ModelDownloadManager()
    ...
    @MainActor
    func testCancelDownload_Filename_WhenQueued_SetsNotDownloaded() {
        let manager = ModelDownloadManager()
    ...
    @MainActor
    func testCancelDownload_Filename_RemovesDownloadProgress() {
        let manager = ModelDownloadManager()
    ...
    @MainActor
    func testCancelDownload_OnNotDownloadedModel_IsSafe() {
        let manager = ModelDownloadManager()
    ...
    @MainActor
    func testCancelDownload_WithMetadata_ConvenienceMethod() {
        let manager = ModelDownloadManager()
    ...
    @MainActor
    func testDeleteThenCancel_DoesNotCrash() {
        let manager = ModelDownloadManager()
    ...
    @MainActor
    func testCancelThenDelete_DoesNotCrash() {
        let manager = ModelDownloadManager()
    ...
    @MainActor
    func testMultipleCancelCalls_DoNotCrash() {
        let manager = ModelDownloadManager()
